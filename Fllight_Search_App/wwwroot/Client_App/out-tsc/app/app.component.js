...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.onSubmit = function () {
        ...
        var headers = new HttpHeaders().set('Content-Type', 'application/json').set('Accept', 'application/json');
        return this.httpClient.post("http://www.ije-api.tcore.xyz/v1/flight/search-flight", {
            "header": { "cookie": this.token }, "body": {
                "origin_destinations": [{
            ...
            _this.result = res["body"]["data"]["itineraries"];
        });
    };
    ...
    //        .subscribe((res: any) => {
    //            console.log("in post " + res);
    //            this.result = res["body"]["data"]["itineraries"];
    //        });
    //}
